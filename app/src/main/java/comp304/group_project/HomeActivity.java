...
public class HomeActivity extends AppCompatActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0: return new NearbyActivity();
                case 1: return new ChatsActivity();
                case 2:return new ContactsActivity();
            }
            return null;
        }
        ...
        public void chats_activity(View view) {

        }

        public void contacts_activity(View view) {
